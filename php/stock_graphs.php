...
// --- Chart Datasets ---
$datasetsDay = [
    ['label' => 'รับเข้า', 'data' => $dailyImport, 'backgroundColor' => 'rgba(46,204,113,0.8)', 'borderRadius' => 5],
    ['label' => 'จ่ายออก', 'data' => $dailyRemove, 'backgroundColor' => 'rgba(231,76,60,0.8)', 'borderRadius' => 5]
];
$datasetsMonth = [
    ['label' => 'รับเข้า', 'data' => $monthlyImport, 'backgroundColor' => 'rgba(46,204,113,0.8)', 'borderRadius' => 5],
    ['label' => 'จ่ายออก', 'data' => $monthlyRemove, 'backgroundColor' => 'rgba(231,76,60,0.8)', 'borderRadius' => 5]
];
$datasetsYear = [
    ['label' => 'รับเข้า', 'data' => $yearlyImport, 'borderColor' => '#2ecc71', 'backgroundColor' => 'rgba(46,204,113,0.2)', 'fill' => true, 'tension' => 0.3],
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (dailyCtx) {
                    dailyChart = new Chart(dailyCtx, {
                        ...
                        data: {
                            ...
                            datasets: <?= json_encode($datasetsDay); ?>
                        },
                ...
                if (pdfButton) {
                    pdfButton.addEventListener('click', async () => {
                        ...
                        try {
                            const response = await fetch('export_stock_graphs.php', {
                                method: 'POST',
                                body: formData
                            });
                ...
                if (emailModal) {
                    ...
                    if (sendEmailButton) {
                        sendEmailButton.addEventListener('click', async function() {
                            ...
                            try {
                                const response = await fetch('send_stock_graphs_email.php', {
                                    method: 'POST',
                                    body: formData
                                });
