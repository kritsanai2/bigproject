...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="transactions_dashboard.php"><i class="fas fa-chart-line"></i>&nbsp; <span>จัดการรายงาน</span></a>
    </div>
                ...
                <table id="transactions-table">
                    ...
                    <tbody>
                        <?php if ($result->num_rows > 0): while ($row = $result->fetch_assoc()): ?>
                            ...
                            <tr>
                                <td colspan="8" style="text-align:center; padding: 2rem;">ไม่มีข้อมูล</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
